...
def runTest(n_layers, hidden_size, reverse, modelFile, beam_size, inp, attn_model='dot'):
    torch.set_grad_enabled(False)

    voc, pairs = loadPrepareData('data/val_x.txt', 'data/val_y.txt')
